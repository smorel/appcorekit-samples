//
//  CKStylesheetSamplePlainFormViewController.m
//  StylesheetSample
//
...
#import "CKStylesheetSamplePlainFormViewController.h"


@interface CKStylesheetSamplePlainFormViewController ()
@end
...
- (void)setup{
    ...
    for(int accessoryType = UITableViewCellAccessoryNone; accessoryType <= UITableViewCellAccessoryCheckmark; ++accessoryType){
        ...
        fullStylesheet.text = [CKStylesheetSamplePlainFormViewController stringRepresentingAccessoryTypeUsingCellController:fullStylesheet];
